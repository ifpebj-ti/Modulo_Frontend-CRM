...
const Picker = ({ handleGetStartEndDate, ...args }: PickerProps) => {
  ...
  return (
    <Datepicker
      ...
      inputClassName={`${args.className} w-full h-full focus:ring-fc-color-100 focus:border-fc-color-100 bg-fc-color-90 rounded-xl border border-solid border-fc-color-80 text-[12px] cursor-pointer max-sm:rounded-[5px] max-sm:text-[0.5rem]`}
