      ...
      {selectedBranchID && startDate && endDate ? (
        <>
          <div className="flex gap-4">
            <Card
              ...
              icon={<Users size={16} />}
              valor={getTotalSalesData.data?.totalSales}
            ...
            <Card
              ...
              icon={<Users size={16} />}
              valor={formatString(getTotalBillingData.data[0]?.totalbilling)}
              showPercentual={false}
              href={"#"}
            />
            <Card
              titulo="Ticket Médio"
              icon={<Users size={16} />}
              valor={formatString(getTicketsByIntervalAndBranchData.data[0].ticketmedio)}
              showPercentual={false}
              href={"#"}
            />
          </div>
        ...
        <>
          <div className="flex justify-center">
            <p>
              Selecione a filial e o período desejado para exibir resultados
            </p>
          </div>
        </>
      )}
